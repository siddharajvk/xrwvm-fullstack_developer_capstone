...
ALLOWED_HOSTS = [
    'localhost',
# "https://siddharajvk-8080.theiadockernext-1-labs-prod-theiak8s-
# 4-tor01.proxy.cognitiveclass.ai"
]
CSRF_TRUSTED_ORIGINS = [
    # 'https://siddharajvk-8080.theiadockerne
    # xt-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/'
]
REST_FRAMEWORK = {
